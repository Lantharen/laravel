...
var wpAjaxUrl = 'https://marathondh.com/wp-admin/admin-ajax.php';
var flBuilderUrl = 'https://marathondh.com/wp-content/plugins/bb-plugin/';
var FLBuilderLayoutConfig = {
    anchorLinkAnimations: {duration: 1000, easing: 'swing', offset: 100},
    paths: {
        pluginUrl: 'https://marathondh.com/wp-content/plugins/bb-plugin/',
        wpAjaxUrl: 'https://marathondh.com/wp-admin/admin-ajax.php'
    },
    breakpoints: {small: 767, medium: 992},
    waypoint: {offset: 80}
};
(function ($) {
...
jQuery(function ($) {
    $(function () {
        $('.fl-node-603ced0be5b66 .fl-photo-img').on('mouseenter', function (e) {
...
jQuery(function ($) {
    $(function () {
        $('.fl-node-603cf1023acf9 .fl-photo-img').on('mouseenter', function (e) {
            $(this).data('title', $(this).attr('title')).removeAttr('title');
        }).on('mouseleave', function (e) {
            $(this).attr('title', $(this).data('title')).data('title', null);
        });

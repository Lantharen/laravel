        ...
        nodeClass: '', wrapperClass: '', type: '', breakPoints: {}, $submenus: null, _isMobile: function () {
            ...
            if (this._isMenuToggle()) {
                ...
                $menu.on('click', '.menu-item > a[href*="#"]:not([href="#"])', function (e) {
                    var $href = $(this).attr('href'), $targetID = $href.split('#')[1], element = $('#' + $targetID);
            ...
            var module = $(this.nodeClass), clone = null, col = module.closest('.fl-col');
            if (module.length < 1) {
                return;
            }
            ...
            var wrapper = $(this.wrapperClass), button = wrapper.find('.fl-menu-mobile-toggle'),
                ...
                winHeight = $(window).height(), fixedHeader = $('header, header > div');
            if (button.hasClass('fl-active')) {
            ...
            var wrapper = $(this.wrapperClass).find('.fl-menu-search-item'), button = wrapper.find('a.fl-button'),
                form = wrapper.find('.fl-search-form-input-wrap'), self = this;
...
(function ($) {
    $(function () {
        new FLBuilderMenu({
            ...
            mobileBelowRow: true,
            mobileFlyout: false,
            breakPoints: {medium: 992, small: 767},

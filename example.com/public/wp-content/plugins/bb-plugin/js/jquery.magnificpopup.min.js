!function (e) {
    ...
    var m, o, g, i, h, t, l = "Close", v = "BeforeClose", y = "MarkupParse", C = "Open", a = "Change", n = "mfp",
    ...
    c.magnificPopup = {
        ...
        proto: e.prototype = {
            constructor: e, init: function () {
                ...
                if ((n = n.tagName ? {el: c(n)} : (t = n.type, {data: n, src: n.src})).el) {
                    for (var o = m.types, i = 0; i < o.length; i++) if (n.el.hasClass("mfp-" + o[i])) {
                        t = o[i];
                        break
                    }
        ...
        r();
        var t, n, o, i = c(this);
        return "string" == typeof e ? "open" === e ? (t = x ? i.data("magnificPopup") : i[0].magnificPopup, n = parseInt(arguments[1], 10) || 0, o = t.items ? t.items[n] : (o = i, (o = t.delegate ? o.find(t.delegate) : o).eq(n)), m._openClick({mfpEl: o}, i, t)) : m.isOpen && m[e].apply(m, Array.prototype.slice.call(arguments, 1)) : (e = c.extend(!0, {}, e), x ? i.data("magnificPopup", e) : i[0].magnificPopup = e, m.addGroup(i, e)), i
    };
            ...
            initImage: function () {
                ...
                function n(e) {
                    A && clearInterval(A), A = setInterval(function () {
                        0 < i.naturalWidth ? m._onImageHasSize(t) : (200 < o && clearInterval(A), 3 === ++o ? n(10) : 40 === o ? n(50) : 100 === o && n(500))
                    }, e)
                }
                ...
                function n() {
                    e && (e.img[0].complete ? (e.img.off(".mfploader"), e === m.currItem && (m._onImageHasSize(e), m.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, p("ImageLoadComplete")) : ++r < 200 ? setTimeout(n, 100) : o())
                }
                ...
                return s.length && ((i = document.createElement("img")).className = "mfp-img", e.el && e.el.find("img").length && (i.alt = e.el.find("img").attr("alt")), e.img = c(i).on("load.mfploader", n).on("error.mfploader", o), i.src = e.src, s.is("img") && (e.img = e.img.clone()), 0 < (i = e.img[0]).naturalWidth ? e.hasSize = !0 : i.width || (e.hasSize = !1)), m._parseMarkup(t, {
                    title: function (e) {
    ...
    c.magnificPopup.registerModule("zoom", {
        options: {
            ...
            initZoom: function () {
                ...
                var t = e ? m.currItem.img : m.st.zoom.opener(m.currItem.el || m.currItem), n = t.offset(),
                    o = parseInt(t.css("padding-top"), 10), e = parseInt(t.css("padding-bottom"), 10);
                n.top -= c(window).scrollTop() - o;
                o = {width: t.width(), height: (x ? t.innerHeight() : t[0].offsetHeight) - e - o};
    ...
    c.magnificPopup.registerModule(F, {
        options: {
            ...
            patterns: {
                ...
                youtu_be: {index: "youtu.be", id: "/", src: "//www.youtube.com/embed/%id%?autoplay=1"},
    ...
    c.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                var r = m.st.gallery, e = ".mfp-gallery";
